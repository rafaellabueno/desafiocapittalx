...
export default function FormAdmin() {
  ...
  return (
    ...
    name="rg" type="text" label="RG" variant="outlined" size="small" required/>
    </Grid>
    <Grid item>
    ...
    name="cpf" type="text" label="CPF" variant="outlined" size="small" required/>
    </Grid>
    </Grid>
    </Box>
    </Grid>
